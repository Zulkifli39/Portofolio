...
function Work({position, company, location, type, duration, detail}) {
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      ...
      <div className="text-justify text-content mt-4 text-xs md:text-sm font-light pl-1 min-w-fit whitespace-pre-line">
        {detail}
      </div>
    </article>
  );
